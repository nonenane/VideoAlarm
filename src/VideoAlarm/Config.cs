...
namespace VideoAlarm
{
    ...
    enum LogEvent
    {
        Добавление_видеорегистратора = 1,
        Редактирование_видеорегистратора = 2,
        Добавление_ответственного_сотрудника = 3,
        Добавление_канала_видеорегистратора = 4,
        Редактирование_канала_видеорегистратора = 5,
        Просмотр_изображения = 6,
        Формирование_расписания_лог_файлов_тревог_с_видеорегистраторов = 7,
        Установлен_признак_Без_тревог_у_записи_события_видеорегистратора = 8,
        Удаление_видеорегистратора = 8,
    }
